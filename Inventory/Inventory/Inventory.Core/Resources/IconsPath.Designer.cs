...
namespace Inventory.Core.Resources {
    ...
    public class IconsPath {
        ...
        public static string PopupEdit {
            get {
                return ResourceManager.GetString("PopupEdit", resourceCulture);
            }
        }
